...
<head>
    ...
    <meta name="description" content="CineAura: Your go-to hub for Indian movies and series. Stream the latest Bollywood hits, regional movies, and popular series in HD. Stay updated with the newest releases and trending content!">
    <meta name="keywords" content="Indian movies, Bollywood, stream movies online, Indian series, HD movies, latest movies, watch series, online cinema">
    <meta name="google-adsense-account" content="ca-pub-5513442153177853">
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    ...
    <title>Stream Latest Indian Movies and Series Online - CineAura</title>
...
<div class="container mt-5 px-3">
    <div class="p-4 rounded-lg shadow-lg d-flex align-items-start mb-4 position-relative" style="background-color: #f8f9fa; color: #212529; border: 1px solid #dee2e6;">
        <!-- Exclamation SVG Icon -->
        <svg xmlns="http://www.w3.org/2000/svg" class="me-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="width: 24px; height: 24px; color: #007bff;">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.29 3.86L1.82 18a1 1 0 00.91 1.5h18.54a1 1 0 00.91-1.5L13.71 3.86a1 1 0 00-1.82 0zM12 9v4m0 4h.01" />
        </svg>

        <!-- Notice Text -->
        <p class="fs-6 fw-semibold" style="margin: 0;">
            ⚠️ <strong>Important Notice:</strong> If you encounter any errors, issues, or broken links while streaming movies or series, or if you have suggestions for improving our content visibility, please leave a comment or join our <a href="https://t.me/yourtelegramgroup" style="text-decoration: underline; color: #007bff;">Telegram group</a>. Your feedback is invaluable, and we strive to enhance your movie-watching experience at CineAura.
        </p>
    </div>
</div>

<h1 class="text-3xl sm:text-4xl md:text-5xl font-extrabold text-center mb-12 text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-blue-500 to-purple-600">
    Welcome to CineAura Indian Hub: Stream the Latest Movies & Series
</h1>

<!-- Brief Introduction for SEO -->
<p class="text-center text-lg text-gray-300 px-6 mb-10 leading-relaxed">
    CineAura Indian Hub is your go-to platform for the latest movies, TV series, and entertainment. Whether you're looking for blockbuster hits, timeless classics, or hidden gems, our expansive library is designed to cater to all tastes. Stream high-quality content from genres like action, drama, comedy, and thrillers, updated regularly for your viewing pleasure.
</p>
...
<div class="container">
    <div class="content-grid">
        ...
        $movie_json = file_get_contents('movie_data1.json');
        $series_json = file_get_contents('series_data1.json');
        $movie_json1 = file_get_contents('movie_data3.json');
        $series_json2 = file_get_contents('series_data3.json'); // New series2.json data
        ...
        $content = array_merge($movies, $movies1, $series, $series2);
...
<script>
   document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateContent(page = 1) {
        ...
        fetch(`search3.php?search=${encodeURIComponent(query)}&page=${page}`)
