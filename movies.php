...
<head>
    ...
    <meta name="google-adsense-account" content="ca-pub-5513442153177853">
     <meta name="description" content="Discover the latest movies and series. Search, browse, and enjoy high-quality movie streaming. Stay updated with new releases and popular picks!">
    <meta name="keywords" content="movies, series, new releases, watch online, streaming, movie reviews, film synopses">
  <meta name="google-adsense-account" content="ca-pub-5513442153177853">
...
<div class="container mx-auto mt-10 px-4">
    <div class="bg-gradient-to-r from-black-500 via-orange-500 to-purple-800 text-white p-4 rounded-lg shadow-lg flex items-start space-x-4 mb-6 halloween-border halloween-shadow">
        ...
        <p class="text-sm sm:text-base md:text-lg font-semibold halloween-text">
            Note: If you encounter any errors, issues, or broken links, or if you have suggestions for better content visibility, please leave a comment or join our Telegram group. We appreciate your feedback and will take action accordingly. <i class="fas fa-ghost animate-pulse"></i> <i class="fas fa-bat animate-wobble"></i> <i class="fas fa-pumpkin animate-spin"></i>
        </p>
    </div>
</div>

<h1 class="text-3xl sm:text-4xl md:text-5xl font-extrabold text-center mb-6 text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-blue-500 to-purple-600 halloween-shadow">
    Explore Popular Movies and Series
</h1>
<p class="text-base sm:text-lg text-center mb-12 text-gray-300">
    Welcome to our curated collection of popular movies and TV series. Whether you're looking for action-packed blockbusters, emotional dramas, or light-hearted comedies, we have something for every mood. Use our search bar to find your favorite titles or explore the latest additions to our library. Enjoy watching with high-quality streaming, detailed synopses, and user reviews to help you decide what's worth your time!
</p>

<h2 class="text-2xl font-bold text-center mt-6 mb-4 halloween-text">
    Latest Movie and Series Releases
</h2>
<p class="text-center text-gray-400">
    Looking for more genres? Explore our <a href="popular_new_movies" class="text-blue-400 hover:text-blue-600">Genres Page</a> to find action, drama, horror, and more!
</p>

<!-- Halloween Features Section -->
<div class="container mx-auto mt-10 px-4 halloween-bg p-6 rounded-lg shadow-lg halloween-border">
    <h2 class="text-xl font-bold text-center mt-6 mb-4 halloween-text">
        Halloween Specials
    </h2>
    <p class="text-base sm:text-lg text-center mb-12 text-gray-300">
        Get into the spooky spirit with our selection of Halloween-themed movies and series! From spine-chilling horror flicks to light-hearted family-friendly options, we have something for everyone this Halloween season.
    </p>
    <ul class="list-disc list-inside text-gray-400 mb-8">
        <li><strong>Horror Classics:</strong> Check out timeless horrors like "Halloween" and "The Shining."</li>
        <li><strong>Family Favorites:</strong> Enjoy fun titles like "Hocus Pocus" and "Coco."</li>
        <li><strong>New Releases:</strong> Don't miss the latest horror hits that are perfect for a fright night!</li>
    </ul>
    <p class="text-center mb-6 text-gray-400">
        Share your favorite Halloween movies in the comments below or join our community on Telegram for more recommendations!
    </p>
</div>

<!-- Call to Action -->
<div class="container mx-auto mt-10 px-4">
    <h2 class="text-xl font-bold text-center mt-6 mb-4 halloween-accent">
        Join Our Halloween Movie Marathon!
    </h2>
    <p class="text-base sm:text-lg text-center mb-12 text-gray-300">
        Participate in our Halloween movie marathon! Vote for your favorite films and join us for a spooky watch party. Check out the details in our Telegram group!
    </p>
</div>
...
<div class="container">
    <div class="content-grid">
        ...
        // Add a source flag for each content group
        ...
        $content = array_merge($movies, $movies1);
...
<script>
   document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateContent(page = 1) {
        ...
        fetch(`search2.php?search=${encodeURIComponent(query)}&page=${page}`)
